...
export class AdminStatusComponent implements OnInit {
  ...
  ngOnInit() {
    console.log(this.searchData); // nie zostawiamy console.logow - mozna ustawic w ESLincie, zeby nam wywalalo warningi na console.logi

    // nie powinnismy tak z tego korzystac. Wiemy, ze data juz jest i czeka na nas wiec skorzystajmy ze snapshotu: this.route.snapshot.data......
